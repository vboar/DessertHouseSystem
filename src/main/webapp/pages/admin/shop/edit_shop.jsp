...
<html>
<head>
    <title>编辑店面 - 店面管理 - 管理后台 - 哆哆甜品屋</title>
...
<div class="wrapper">
    <div class="content">
        <div class="admin-panel">
            ...
            <input type="text" class="normal-input" id="js-name-input" value="${shop.name}"/>
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data["success"] == false) {
                    ...
                    setTimeout(function () {
                        window.location.href = "/admin/shop/detail?id=" + $("#js-id-input").val();
                    }, 1000);
                }
            },
            error: function() {
