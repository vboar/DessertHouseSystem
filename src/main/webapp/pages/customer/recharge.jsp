...
<div class="wrapper">
    <div class="content">
        ...
        <div class="right-content">
            ...
            <div id="input-div">
                <label for="js-money-input" class="normal-input-label">充值金额（至少10元）</label>
                <input type="number" id="js-money-input" class="normal-input">
                <label for="js-password-input" class="normal-input-label">请输入密码</label>
            ...
            <div id="tips">
                <div class="normal-div">· 一次性充值200元，升级为 普通会员</div>
                <div class="normal-div">· 一次性充值688元，升级为 青铜会员</div>
                <div class="normal-div">· 一次性充值1288元，升级为 白银会员</div>
                <div class="normal-div">· 一次性充值1888元，升级为 黄金会员</div>
                <div class="normal-div">· 一次性充值3888元，升级为 钻石会员</div>
                <div class="normal-div">· 一次性充值8888元，升级为 超级会员</div>
            </div>
